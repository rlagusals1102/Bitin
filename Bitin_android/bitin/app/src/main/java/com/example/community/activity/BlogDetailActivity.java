...
import com.example.community.databinding.ActivityBlogDetailBinding;
    ...
    private void showdata() {
        ...
        FirebaseFirestore.getInstance().collection("Blogs").document(id).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.textView4.setText(Html.fromHtml("<font color='B7B7B7'>By </font> <font color='@color/purple_500'>"+value.getString("author")));
